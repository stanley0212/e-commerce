                ...
                <div className="flex flex-col justify-between w-full">
                  ...
                  <div className="">
                    ...
                    <div className="flex items-center justify-between gap-8">
                      ...
                      <div className="p-1 bg-red-50 rounded-sm flex gap-2">
                        {item.quantity && item.quantity > 1 && <div className=" text-xs text-rose-500">{item.quantity} * </div>}${item.price?.amount}
                      </div>
                    </div>
                    {/* DESCRIPTION */}
